...
class ParticipantController extends AbstractController
{
    ...
    public function index(ParticipantRepository $participantRepository, EntityManagerInterface $em, PaginatorInterface $paginator, Request $request): Response
    {
        $query = $participantRepository->findAll();
